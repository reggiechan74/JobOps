...
6. **Output filename** (fixed; only the sub-folder above is resolved dynamically): write the briefing to `interview/briefing.md`; a split briefing uses `interview/briefing_part1.md`, `interview/briefing_part2.md`, ….
