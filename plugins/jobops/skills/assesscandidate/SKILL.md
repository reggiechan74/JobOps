...
6. **Output filename** (fixed; only the sub-folder above is resolved dynamically): write the candidate assessment to `assessment/assessment.md` (and pin the rubric at `assessment/rubric.md`).
